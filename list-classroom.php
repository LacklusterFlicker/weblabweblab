...
$clss = $classroomMap->findAll($page*$size-$size, $size);
...
<a class="btn btn-success" href="add-classroom.php">Добавить класс</a>
...
<?php } else {
echo 'Ни одного класса не найдено';
} ?>
</div>
<div class="box-body">
